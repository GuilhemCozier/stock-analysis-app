...
export const mockSectorAnalysis = {
  ...
  status: 'completed',
  summary: 'The cybersecurity sector shows robust growth driven by digital transformation, rising threat sophistication, and mandatory compliance requirements. Key opportunities exist in AI-powered threat detection, cloud security, and identity management.',
  ...
  subSectors: [
    {
      ...
      shortDescription: 'AI-driven threat detection and automated response at enterprise scale.',
      summary:
    ...
    },
    {
      id: 'sub-2',
      name: 'Cloud Security',
      shortDescription: 'Securing multi-cloud infrastructure and cloud-native applications.',
      summary:
    ...
    },
    {
      ...
      shortDescription: 'Zero-trust access, strong authentication, and privileged controls.',
      summary:
    ...
    },
    {
      ...
      shortDescription: 'Protecting endpoints across laptops, servers, mobile, and IoT.',
      summary:
